...
(function () {
  ...
  const GUIDELINES = [
    ...
    '',
    '• Min Credit Score: 640 (all aggregators except PHH and Mr. Cooper).',
    '   – PHH requires ≥ 680.',
    '   – Mr. Cooper does NOT permit manual underwrites.',
    '• Max DTI for manual UW: 50%.',
    '• Eligible Investors: Amerihome, PennyMac, PHH.',
    '',
    'Reserves: 1–2 Units = 1 month PITIA, 3–4 Units = 3 months.',
    '',
    'Max DTI ratios with compensating factors:',
    '• 31/43 — No compensating factors (33/45 for Energy Efficient Homes).',
    '• 37/47 — ONE compensating factor:',
    '   – 3 mo (1–2 units) / 6 mo (3–4 units) cash reserves, OR',
    '   – Minimal increase in housing payment (lower of $100 or 5%), OR',
    '   – Residual income (VA tables).',
    '• 40/40 — No discretionary debt (all accounts paid in full or paid monthly 6+ months).',
    '• 40/50 — TWO compensating factors:',
    '   – Cash reserves (3 mo / 6 mo as above), AND/OR',
    '   – Minimal increase in housing payment ($100 or 5%), AND/OR',
    '   – Significant additional income not in effective income, AND/OR',
    '   – Residual income (VA tables).',
    '',
    'NOTE: Compensating factors may only be used to exceed FRONT-end ratio limits. Manual UW still has a max BACK-end ratio.',
    '',
    'References: HUD Handbook 4000.1 II.A.5.viii; VA Handbook Ch. 4 §9 for residual income.'
  ].join('\n');
